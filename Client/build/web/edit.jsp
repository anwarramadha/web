...
<html>
	...
	<div class="title">
		...
		<div class="catalog-list">
               <%
                out.print("<form name=\"editproduct\" onsubmit=\"return validateAdd()\" method=\"POST\" action=\"http://localhost:8080/Client/updateproduct\">");
                out.print("<div class=\"errormessage\" id=\"error-productname\"></div>");
                    ...
                    int catalogid = Integer.parseInt(request.getParameter("id_product"));
                     out.print("<input type=\"hidden\" id=\"id_product\" name=\"id_product\" value=\""+ catalogid +"\">");
