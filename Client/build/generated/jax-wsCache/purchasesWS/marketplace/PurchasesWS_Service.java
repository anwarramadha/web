 ...
 * 
 */
@WebServiceClient(name = "purchasesWS", targetNamespace = "http://marketplace/", wsdlLocation = "http://localhost:8082/WebService/purchasesWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PURCHASESWS_QNAME = new QName("http://marketplace/", "purchasesWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8082/WebService/purchasesWS?wsdl");
    ...
    public PurchasesWS getPurchasesWSPort() {
        return super.getPort(new QName("http://marketplace/", "purchasesWSPort"), PurchasesWS.class);
    }
    ...
    public PurchasesWS getPurchasesWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://marketplace/", "purchasesWSPort"), PurchasesWS.class, features);
    }
